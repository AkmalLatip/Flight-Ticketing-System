        ...
        <form action="#">
            ...
            <div class="form-group d-sm-flex margin">
                ...
                <div class="form-group my-3">
                    <div class="btn btn-primary rounded-0 d-flex rounded justify-content-center text-center p-3">Modify
                    </div>
                </div>
            </div>
        </form>
        ...
        <div class="row">
            <div class="min-h-screen">
              ...
              <div class="bg-blue rounded shadow p-8">
                  ...
                  <div class="border w-full rounded mt-5 flex p-4 justify-between items-center flex-wrap">
                   <div class="row">
                    ...
                    <div class="w-2/3 col-6">
                      ...
                      <h4 class="text-red-700 text-xs font-bold mt-1">BOEING 77-90</h4>
                    </div>
                ...
                <button class="px-4 py-4 bg-white text-purple-700 w-full mt-3 rounded shadow font-bold hover:bg-purple-100">PROCEED TO BOOKING PAGE</button>
              </div>
          </div>                                      
        </div>
      </div>
